...
public class RealizedDayCalendarDecorator implements DayViewDecorator {

    private Context context;
    private ArrayList<LocalDate> dates;
    private boolean drawNumericalRealization;

    public RealizedDayCalendarDecorator(ArrayList<LocalDate> dates, Context context, boolean drawNumericalRealization) {
    ...
    public void decorate(DayViewFacade view) {
        view.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.rectangle_main_green));
    }
}
